...
const conformanceColors: Record<Conformance, string> = {
  ...
  "Not Applicable": "text-muted-foreground bg-navy-50 border-border",
};
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                <tr className="border-t border-border">
                  ...
                  <td className="py-2 px-3"><span className="rounded-full bg-navy-50 text-muted-foreground border border-border px-2 py-0.5 text-[10px] font-bold">Not Applicable</span></td>
          ...
          <div className="rounded-xl border border-border overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                <tr className="border-t border-border"><td className="py-2 px-3 text-xs font-semibold text-navy">Chapter 6 — ICT with Two-Way Voice Comm</td><td className="py-2 px-3"><span className="rounded-full bg-navy-50 text-muted-foreground border border-border px-2 py-0.5 text-[10px] font-bold">Not Applicable</span></td><td className="py-2 px-3 text-xs text-charcoal">No voice communication features.</td></tr>
                <tr className="border-t border-border"><td className="py-2 px-3 text-xs font-semibold text-navy">Chapter 7 — ICT with Video Capabilities</td><td className="py-2 px-3"><span className="rounded-full bg-navy-50 text-muted-foreground border border-border px-2 py-0.5 text-[10px] font-bold">Not Applicable</span></td><td className="py-2 px-3 text-xs text-charcoal">No video features.</td></tr>
                <tr className="border-t border-border"><td className="py-2 px-3 text-xs font-semibold text-navy">Chapter 8 — Hardware</td><td className="py-2 px-3"><span className="rounded-full bg-navy-50 text-muted-foreground border border-border px-2 py-0.5 text-[10px] font-bold">Not Applicable</span></td><td className="py-2 px-3 text-xs text-charcoal">Software only.</td></tr>
                ...
                <tr className="border-t border-border"><td className="py-2 px-3 text-xs font-semibold text-navy">Chapter 10 — Non-Web Documents</td><td className="py-2 px-3"><span className="rounded-full bg-navy-50 text-muted-foreground border border-border px-2 py-0.5 text-[10px] font-bold">Not Applicable</span></td><td className="py-2 px-3 text-xs text-charcoal">No non-web documents produced. This VPAT itself is an HTML web document.</td></tr>
                <tr className="border-t border-border"><td className="py-2 px-3 text-xs font-semibold text-navy">Chapter 11 — Non-Web Software</td><td className="py-2 px-3"><span className="rounded-full bg-navy-50 text-muted-foreground border border-border px-2 py-0.5 text-[10px] font-bold">Not Applicable</span></td><td className="py-2 px-3 text-xs text-charcoal">Web-based product.</td></tr>
